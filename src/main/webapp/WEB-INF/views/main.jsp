	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta"><a href="/rsv/register" id="regBtn" class="nav-link" ><span>Make an Appointment</span></a></li>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              ...
              <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="/rsv/register" id="regBtn"  class="btn btn-primary px-4 py-3">Make an Appointment</a></p>
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              ...
              <p><a href="/rsv/register" id="regBtn" class="btn btn-primary px-4 py-3">Make an Appointment</a></p>
<!--               <p><a href="#" data-toggle="modal" data-target="#modalRequest" class="btn btn-primary px-4 py-3">Make an Appointment</a></p> -->
            </div>
          </div>
        </div>
      </div>
