...
<%@include file="../includes/header.jsp" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">예약 수정페이지</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<%-- 			<div class="form-group">
			 ...
			 <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"/>
				...
				<br>
             	<div class="form-group">
             		<label>증상</label>
             		<textarea class="form-control1" rows="3" name="reservation_sympton">${board.reservation_sympton }</textarea>                            	
             	</div>
             	<br>
             	<div>
       				<label>날짜입력<label>
...
<!--              	<div>
             		<label>시간</label>
             		<input class="form-control1" name="reservation_time">
	            </div>
             	<br> -->
             	<div>
...
<%--              	<div class="form-group" >
             	...
             	<div class="form-group">
             		<label>증상</label>
             		<textarea class="form-control1" rows="3" name="reservation_sympton"
             		value='dkvk'></textarea>                            	
             	</div>
             	...
             	<div>
             		<form action="#" accept-charset="utf-8" name="datalist" method="get">
             			...
             			<legend>날짜선택</legend>
             				날짜입력
             				<input type="date" min="2022-08-01" max="2099-12-31" name="reservation_date" step="1"
             				value='<c:out value="${board.reservation_date }" />'>
             	...
             	<div>
             		<label>시간</label>
             		<input class="form-control1" name="reservation_time"
             		value='<c:out value="${board.reservation_time }" />'>
	            </div> --%>
