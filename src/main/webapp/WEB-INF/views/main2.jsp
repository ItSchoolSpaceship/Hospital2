...
<html lang="ko">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta"><a href="/board/register" class="nav-link" ><span>Make an Appointment</span></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
    ...
    <!-- data-toggle="modal" data-target="#modalRequest" 모달달 창으로 연결 -->
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              ...
              <p><a href="#" id="regBtn"  class="btn btn-primary px-4 py-3">Make an Appointment</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="ftco-section ftco-services">
      ...
      <div class="container-wrap mt-5">
      	<div class="row d-flex no-gutters">
      		<div class="col-md-6 img" style="background-image: url(/resources/images/about-2.jpg);">
      		</div>
...
<!--         <div class="modal-body">
          <form action="/rsv/register">
            <div class="form-group"> 
              <label for="appointment_name" class="text-black">Full Name</label>
              <label>아이디 : 아무개</label> -->
              <!-- <input type="text" class="form-control" id="member_name" placeholder="Full Name"> -->
              
<!--             </div>
            <div class="form-group">
              <label for="appointment_email" class="text-black">Email</label>
               <label>전화번호</label>
              <input type="text" class="form-control" id="member_email" placeholder="Email">
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label>예약일</label>
                  <input type="text" class="form-control appointment_date" placeholder="예약일">
                </div>    
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label>예약시간</label>
                  <input type="text" class="form-control appointment_time" placeholder="예약시간">
                </div>
              </div>
            </div> -->
